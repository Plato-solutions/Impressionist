 ...
 */
class Logger { // TODO: Refactor removing duplicated code. Proxy Object instead of a Class?
    ...
    static #formatElements(elements) {
        ...
        for(const element in elements) {
            result.push({
                name: element,
                //value: (function stringify() { try { return JSON.stringify(elements[element]) } catch { return null } } )(), //FIXME: Some elements throws errors when trying to convert it to JSON.
