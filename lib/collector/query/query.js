...
class Query {
    ...
    #setSingleAsDefault() {
        ...
        while(currentNode) {
            if(currentNode.implementation.constructor.name === 'All' || currentNode.implementation.constructor.name === 'Single' || currentNode.implementation.constructor.name === 'Elements' || currentNode.implementation.constructor.name === 'Options') {
