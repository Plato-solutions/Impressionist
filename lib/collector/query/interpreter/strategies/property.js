 ...
 */
 class InterpreterPropertyStrategy {
    ...
    static interpret(selector) {
        ...
        return new Css(normalizedElementSelector).setGetElement(elementSelector.startsWith('document')?new Context():undefined).property(property)[selector.endsWith('*')?'all':'single']();
    }
