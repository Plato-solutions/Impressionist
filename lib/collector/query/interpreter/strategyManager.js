...
import InterpreterMissingStrategy from "./strategies/missing.js";
...
class InterpreterStrategyManager {
     ...
     */
    static #strategies = new Set([InterpreterMissingStrategy]);
     ...
     */
    static add(strategy) {
        console.log('Registering a new strategy', strategy.name);
    ...
    static lookUp(selector) {
        ...
        return StrategyManager.lookUp(selector, InterpreterStrategyManager.#strategies);
    }
}
