...
class Merge extends Selector {
    ...
    async execute(context) {
        ...
        if(!(context instanceof Context)) {
            throw new Error('Merge - The context is not an instance of Context class.');
        }
    ...
    validateParameters() {
        if(!Array.isArray(this.definition)) {
            throw new Error(`Merge - Constructor definition should be an array. Instead it received a ${typeof this.definition}.`);
        }
    }
