...
class Xpath extends Selector {
    ...
    async execute(context) {
        ...
        if(!(context instanceof Context)) {
            throw new Error('Xpath - The context is not an instance of Context class.');
        }
    ...
    validateParameters() {
        if(typeof this.definition !== 'string') {
            throw new Error(`Xpath - Constructor definition should be a string. Instead it received a ${typeof this.definition}.`);
        }
    }
