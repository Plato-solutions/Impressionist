...
class Css extends Selector {
    ...
    async execute(context) {
        ...
        if(!(context instanceof Context)) {
            throw new Error('Css - The context is not an instance of Context class.');
        }
    ...
    validateParameters() {
        if(typeof this.definition !== 'string') {
            throw new Error(`Css - Constructor definition should be a string. Instead it received a ${typeof this.definition}.`);
        }
    }
