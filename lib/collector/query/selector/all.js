...
class All extends Selector {
    ...
    async execute(context) {
        ...
        if(!(context instanceof Context)) {
            throw new Error('All - The context is not an instance of Context class.');
        }
    ...
    validateParameters() {
        ...
        if(!(definition === undefined ?? definition === Object)) {
            throw new Error(`All - Constructor definition should be an object or empty. Instead it received a ${typeof this.definition}.`);
        }
    }
}
