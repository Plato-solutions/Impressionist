 ...
 *  name: css('h1').property('innerText').post(pluginName => pluginName.trim())
 * }).call();
 * ```
 */
class Post extends Selector {
    ...
    async execute(context) {
        ...
        try {
            ...
            Logger.error('Post', 'Execution of a custom function failed with the following message: ' + e.message);
        }
    }
